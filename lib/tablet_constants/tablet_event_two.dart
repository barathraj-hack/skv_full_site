...
class MyTabletEventTwo extends StatefulWidget {
  const MyTabletEventTwo({super.key});

  @override
  State<MyTabletEventTwo> createState() => _MyTabletEventTwoState();
}

class _MyTabletEventTwoState extends State<MyTabletEventTwo> {
  // List of image paths
