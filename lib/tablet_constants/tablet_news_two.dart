...
class MyTabletNewsTwo extends StatefulWidget {
  const MyTabletNewsTwo({super.key});

  @override
  State<MyTabletNewsTwo> createState() => _MyTabletNewsTwoState();
}

class _MyTabletNewsTwoState extends State<MyTabletNewsTwo> {
  // List of image paths
