...
class MyTabletEventOne extends StatefulWidget {
  const MyTabletEventOne({super.key});

  @override
  State<MyTabletEventOne> createState() => _MyTabletEventOneState();
}

class _MyTabletEventOneState extends State<MyTabletEventOne> {
  // List of image paths
